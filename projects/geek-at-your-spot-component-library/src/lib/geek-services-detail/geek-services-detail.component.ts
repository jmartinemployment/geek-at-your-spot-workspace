...
@Component({
  selector: 'geek-services-detail',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './geek-services-detail.component.html',
  styleUrl: './geek-services-detail.component.scss'
})
export class GeekServicesDetailComponent implements OnInit, OnDestroy {
