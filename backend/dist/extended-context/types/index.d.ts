 ...
 */
export type CompressionStrategy = 'truncate' | 'summarize' | 'hierarchical' | 'importance' | 'hybrid';
/**
 ...
 */
export type ContextWindowEvent = 'message_added' | 'message_removed' | 'compressed' | 'summarized' | 'threshold_warning' | 'threshold_exceeded' | 'snapshot_created' | 'rollback_performed';
/**
 * Context event
 */
