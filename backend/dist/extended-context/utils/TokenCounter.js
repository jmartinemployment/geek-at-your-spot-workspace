...
class TokenCounter {
     ...
     */
    static countTokens(text, options) {
     ...
     */
    static countSpecialTokens(text) {
        let extraTokens = 0;
     ...
     */
    static calculateMessageLimit(messages, maxTokens, systemTokens = 0) {
     ...
     */
    static splitIntoChunks(text, maxTokensPerChunk, overlapTokens = 0) {
        const chunks = [];
     ...
     */
    static getLastNTokens(text, tokens) {
     ...
     */
    static trimToTokenLimit(text, maxTokens) {
     ...
     */
    static calculateTokenBudget(maxTokens, allocations) {
     ...
     */
    static getUsagePercentage(currentTokens, maxTokens) {
        return Math.min(100, (currentTokens / maxTokens) * 100);
    }
    /**
     * Estimate compression ratio needed
     */
    static estimateCompressionNeeded(currentTokens, targetTokens) {
