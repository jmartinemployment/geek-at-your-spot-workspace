...
exports.DefaultProcessors = exports.JobProcessor = void 0;
class JobProcessor {
    queue;
    processors = new Map();
    processingLoop = null;
...
class DefaultProcessors {
     ...
     */
    static codeExecution = async (job, context) => {
     ...
     */
    static costCalculation = async (job, context) => {
     ...
     */
    static timelineGeneration = async (job, context) => {
     ...
     */
    static feasibilityCheck = async (job, context) => {
     ...
     */
    static a2aWorkflow = async (job, context) => {
     ...
     */
    static contextCompression = async (job, context) => {
     ...
     */
    static bulkAnalysis = async (job, context) => {
     ...
     */
    static reportGeneration = async (job, context) => {
     ...
     */
    static dataExport = async (job, context) => {
