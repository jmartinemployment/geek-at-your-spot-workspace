...
class PricingServer {
    ...
    async estimateProjectCost(params, _context) {
        try {
    ...
    async getFeaturePricing(params, _context) {
        try {
    ...
    async comparePricingOptions(params, _context) {
        try {
    ...
    async suggestCostOptimizations(params, _context) {
        try {
    ...
    calculateTotalCost(features, projectType, complexity = 'medium') {
        const projectMult = this.projectTypeMultipliers[projectType] || 1.0;
        const complexityMult = this.complexityMultipliers[complexity];
...
exports.PricingServer = PricingServer;
//# sourceMappingURL=PricingServer.js.map