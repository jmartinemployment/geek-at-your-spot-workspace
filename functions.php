...
function initialize_styles()
{
  ...
  wp_register_style('my-elements-css', get_template_directory_uri() . '/assets/css/styles-N23ZFAQD.css', false);
  wp_enqueue_style('my-elements-css', get_template_directory_uri() . '/assets/css/styles-N23ZFAQD.css', array(), '1.0.0', 'all');
